...
set.seed(100)
narfimaT_ind_1 <-  auto.narfima(train_ind_1, arfima_er_ind_1, p = 2, q = 1, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_ind_1)
set.seed(100)
narfimaT_ind_1_pred <-  forecast.narfima(narfimaT_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
set.seed(100)
narfimaT_ind_3 <-  auto.narfima(train_ind_3, arfima_er_ind_3, p = 4, q = 3, size = 4, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_ind_3)
set.seed(100)
narfimaT_ind_3_pred <-  forecast.narfima(narfimaT_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
set.seed(100)
narfimaT_ind_6 <-  auto.narfima(train_ind_6, arfima_er_ind_6, p = 4, q = 2, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_ind_6)
set.seed(100)
narfimaT_ind_6_pred <-  forecast.narfima(narfimaT_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
set.seed(100)
narfimaT_ind_12 <-  auto.narfima(train_ind_12, arfima_er_ind_12, p = 1, q = 3, size = 4, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_ind_12)
set.seed(100)
narfimaT_ind_12_pred <-  forecast.narfima(narfimaT_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
