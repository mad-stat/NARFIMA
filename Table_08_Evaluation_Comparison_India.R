...
set.seed(100)
narfimaT_ind_1_pred <-  forecast_narfima(narfimaT_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
set.seed(100)
narfimaT_ind_3_pred <-  forecast_narfima(narfimaT_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
set.seed(100)
narfimaT_ind_6_pred <-  forecast_narfima(narfimaT_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
set.seed(100)
narfimaT_ind_12_pred <-  forecast_narfima(narfimaT_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
...
set.seed(100)
narfimaT_ind_24_pred <-  forecast_narfima(narfimaT_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
set.seed(100)
...
set.seed(100)
narfimaT_ind_48_pred <-  forecast_narfima(narfimaT_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
set.seed(100)
