...
set.seed(100)
narfima_braz_1 <-  auto_narfima(train_braz_1, arfima_er_braz_1, p = 5, q = 4, size = 4, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_braz_1)
set.seed(100)
narfima_braz_1_pred <-  forecast_narfima(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
set.seed(100)
...
set.seed(100)
narfima_braz_3_pred <-  forecast_narfima(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
set.seed(100)
...
set.seed(100)
narfima_braz_6 <-  auto_narfima(train_braz_6, arfima_er_braz_6, p = 1, q = 2, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_braz_6)
set.seed(100)
narfima_braz_6_pred <-  forecast_narfima(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
set.seed(100)
...
set.seed(100)
narfima_braz_12 <-  auto_narfima(train_braz_12, arfima_er_braz_12, p = 1, q = 1, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_braz_12)
set.seed(100)
narfima_braz_12_pred <-  forecast_narfima(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
set.seed(100)
...
set.seed(100)
narfima_braz_24_pred <-  forecast_narfima(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
set.seed(100)
...
set.seed(100)
narfimaT_braz_48_pred <-  forecast_narfima(narfimaT_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
set.seed(100)
