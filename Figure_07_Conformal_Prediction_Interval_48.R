...
conf_narfimaT_braz_48_pred <- predict(conf_narfimaT_braz_48, y_hat = narfimaT_braz_48_pred$mean, sigmas = NULL, confidence = 0.80, y_min = -Inf, y_max = Inf)
posterior_interval_brazT_48 <- as_tibble(cbind.data.frame('L' = conf_narfimaT_braz_48_pred$lower_80,'U' = conf_narfimaT_braz_48_pred$upper_80))

mean(conf_narfimaT_braz_48_pred$upper_80 - conf_narfimaT_braz_48_pred$lower_80)
...
conf_narfima_rus_48_pred <- predict(conf_narfima_rus_48, y_hat = narfima_rus_48_pred$mean, sigmas = NULL, confidence = 0.80, y_min = -Inf, y_max = Inf)
posterior_interval_rus_48 <- as_tibble(cbind.data.frame('L' = conf_narfima_rus_48_pred$lower_80,'U' = conf_narfima_rus_48_pred$upper_80))
mean(conf_narfima_rus_48_pred$upper_80 - conf_narfima_rus_48_pred$lower_80)
...
set.seed(100)
narfimaT_ind_48 <-  auto.narfima(train_ind_48, arfima_er_ind_48, p = 2, q = 4, size = 4, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_ind_48)
set.seed(100)
narfimaT_ind_48_pred <-  forecast.narfima(narfimaT_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
...
conf_narfimaT_ind_48_pred <- predict(conf_narfimaT_ind_48, y_hat = narfimaT_ind_48_pred$mean, sigmas = NULL, confidence = 0.80, y_min = -Inf, y_max = Inf)
posterior_interval_indT_48 <- as_tibble(cbind.data.frame('L' = conf_narfimaT_ind_48_pred$lower_80,'U' = conf_narfimaT_ind_48_pred$upper_80))
mean(conf_narfimaT_ind_48_pred$upper_80 - conf_narfimaT_ind_48_pred$lower_80)
...
conf_narfimaT_chn_48_pred <- predict(conf_narfimaT_chn_48, y_hat = narfimaT_chn_48_pred$mean, sigmas = NULL, confidence = 0.80, y_min = -Inf, y_max = Inf)
posterior_interval_chnT_48 <- as_tibble(cbind.data.frame('L' = conf_narfimaT_chn_48_pred$lower_80,'U' = conf_narfimaT_chn_48_pred$upper_80))

mean(conf_narfimaT_chn_48_pred$upper_80 - conf_narfimaT_chn_48_pred$lower_80)
