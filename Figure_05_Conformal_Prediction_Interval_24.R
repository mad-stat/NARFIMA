...
set.seed(100)
narfima_braz_24 <-  auto_narfima(train_braz_24, arfima_er_braz_24, p = 2, q = 5, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_braz_24)
set.seed(100)
...
conf_narfima_braz_24_pred <- predict(conf_narfima_braz_24, y_hat = narfima_braz_24_pred$mean, sigmas = NULL, confidence = 0.95, y_min = -Inf, y_max = Inf)
posterior_interval_braz_24 <- as_tibble(cbind.data.frame('L' = conf_narfima_braz_24_pred$lower_95,'U' = conf_narfima_braz_24_pred$upper_95))

mean(conf_narfima_braz_24_pred$upper_95 - conf_narfima_braz_24_pred$lower_95)
...
set.seed(100)
narfima_rus_24 <-  auto_narfima(train_rus_24, arfima_er_rus_24, p = 1, q = 1, size = 5, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_rus_24, seed = 1)
set.seed(100)
...
conf_narfima_rus_24_pred <- predict(conf_narfima_rus_24, y_hat = narfima_rus_24_pred$mean, sigmas = NULL, confidence = 0.95, y_min = -Inf, y_max = Inf)
posterior_interval_rus_24 <- as_tibble(cbind.data.frame('L' = conf_narfima_rus_24_pred$lower_95,'U' = conf_narfima_rus_24_pred$upper_95))
mean(conf_narfima_rus_24_pred$upper_95 - conf_narfima_rus_24_pred$lower_95)
...
conf_narfimaT_ind_24_pred <- predict(conf_narfimaT_ind_24, y_hat = narfimaT_ind_24_pred$mean, sigmas = NULL, confidence = 0.95, y_min = -Inf, y_max = Inf)
posterior_interval_indT_24 <- as_tibble(cbind.data.frame('L' = conf_narfimaT_ind_24_pred$lower_95,'U' = conf_narfimaT_ind_24_pred$upper_95))
mean(conf_narfimaT_ind_24_pred$upper_95 - conf_narfimaT_ind_24_pred$lower_95)
...
conf_narfimaT_chn_24_pred <- predict(conf_narfimaT_chn_24, y_hat = narfimaT_chn_24_pred$mean, sigmas = NULL, confidence = 0.95, y_min = -Inf, y_max = Inf)
posterior_interval_chnT_24 <- as_tibble(cbind.data.frame('L' = conf_narfimaT_chn_24_pred$lower_95,'U' = conf_narfimaT_chn_24_pred$upper_95))
mean(conf_narfimaT_chn_24_pred$upper_95 - conf_narfimaT_chn_24_pred$lower_95)
