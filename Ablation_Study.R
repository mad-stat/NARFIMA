...
set.seed(100)
narfima_braz_1 <-  auto_narfima(train_braz_1, arfima_er_braz_1, p = 5, q = 4, size = 4  , skip = F, xreg = train_reg_braz_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_1_pred <-  forecast_narfima_class(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
set.seed(100)
...
set.seed(100)
narfima_braz_1 <-  auto_narfima(train_braz_1, arima_er_braz_1, p = 5, q = 4, size = 4  , skip = F, xreg = train_reg_braz_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_1_pred <-  forecast_narfima_class(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
set.seed(100)
...
set.seed(100)
narfima_braz_1 <-  auto_narfima(train_braz_1, bsts_er_braz_1, p = 5, q = 4, size = 4  , skip = F, xreg = train_reg_braz_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_1_pred <-  forecast_narfima_class(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
set.seed(100)
...
set.seed(100)
narfima_braz_1 <-  auto_narfima(train_braz_1, naive_er_braz_1, p = 5, q = 4, size = 4, skip = F, xreg = train_reg_braz_1, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_1_pred <-  forecast_narfima_class(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
set.seed(100)
...
#set.seed(100)
#narfima_braz_1 <-  auto_narfima(train_braz_1, tbats_er_braz_1, p = 5, q = 4, size = 4  , skip = F, xreg = train_reg_braz_1, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_1_pred <-  forecast_narfima_class(narfima_braz_1, PI = FALSE, h = n, xreg = test_reg_braz_1)
#set.seed(100)
...
set.seed(100)
narfima_braz_3 <-  auto_narfima(train_braz_3, arfima_er_braz_3, p = 2, q = 5, size = 2, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_braz_3)
set.seed(100)
narfima_braz_3_pred <-  forecast_narfima_class(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
set.seed(100)
...
set.seed(100)
narfima_braz_3 <-  auto_narfima(train_braz_3, arima_er_braz_3, p = 2, q = 5, size = 2  , skip = F, xreg = train_reg_braz_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_3_pred <-  forecast_narfima_class(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
set.seed(100)
...
set.seed(100)
narfima_braz_3 <-  auto_narfima(train_braz_3, bsts_er_braz_3, p = 2, q = 5, size = 2  , skip = F, xreg = train_reg_braz_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_3_pred <-  forecast_narfima_class(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
set.seed(100)
...
set.seed(100)
narfima_braz_3 <-  auto_narfima(train_braz_3, naive_er_braz_3, p = 2, q = 5, size = 2  , skip = F, xreg = train_reg_braz_3, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_3_pred <-  forecast_narfima_class(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
set.seed(100)
...
#set.seed(100)
#narfima_braz_3 <-  auto_narfima(train_braz_3, tbats_er_braz_3, p = 2, q = 5, size = 2  , skip = F, xreg = train_reg_braz_3, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_3_pred <-  forecast_narfima_class(narfima_braz_3, PI = FALSE, h = n, xreg = test_reg_braz_3)
#set.seed(100)
...
set.seed(100)
narfima_braz_6 <-  auto_narfima(train_braz_6, arfima_er_braz_6, p = 1, q = 2, size = 1  , skip = F, xreg = train_reg_braz_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_6_pred <-  forecast_narfima_class(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
set.seed(100)
...
set.seed(100)
narfima_braz_6 <-  auto_narfima(train_braz_6, arima_er_braz_6, p = 1, q = 2, size = 1  , skip = F, xreg = train_reg_braz_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_6_pred <-  forecast_narfima_class(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
set.seed(100)
...
set.seed(100)
narfima_braz_6 <-  auto_narfima(train_braz_6, bsts_er_braz_6, p = 1, q = 2, size = 1  , skip = F, xreg = train_reg_braz_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_6_pred <-  forecast_narfima_class(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
set.seed(100)
...
set.seed(100)
narfima_braz_6 <-  auto_narfima(train_braz_6, naive_er_braz_6, p = 1, q = 2, size = 1, skip = F, xreg = train_reg_braz_6, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_6_pred <-  forecast_narfima_class(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
set.seed(100)
...
#set.seed(100)
#narfima_braz_6 <-  auto_narfima(train_braz_6, tbats_er_braz_6, p = 1, q = 2, size = 1, skip = F, xreg = train_reg_braz_6, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_6_pred <-  forecast_narfima_class(narfima_braz_6, PI = FALSE, h = n, xreg = test_reg_braz_6)
#set.seed(100)
...
set.seed(100)
narfima_braz_12 <-  auto_narfima(train_braz_12, arfima_er_braz_12, p = 1, q = 1, size = 1  , skip = F, xreg = train_reg_braz_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_12_pred <-  forecast_narfima_class(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
set.seed(100)
...
set.seed(100)
narfima_braz_12 <-  auto_narfima(train_braz_12, arima_er_braz_12, p = 1, q = 1, size = 1  , skip = F, xreg = train_reg_braz_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_12_pred <-  forecast_narfima_class(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
set.seed(100)
...
set.seed(100)
narfima_braz_12 <-  auto_narfima(train_braz_12, bsts_er_braz_12, p = 1, q = 1, size = 1  , skip = F, xreg = train_reg_braz_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_12_pred <-  forecast_narfima_class(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
set.seed(100)
...
set.seed(100)
narfima_braz_12 <-  auto_narfima(train_braz_12, naive_er_braz_12, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_braz_12, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_12_pred <-  forecast_narfima_class(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
set.seed(100)
...
#set.seed(100)
#narfima_braz_12 <-  auto_narfima(train_braz_12, tbats_er_braz_12, p = 1, q = 1, size = 1  , skip = F, xreg = train_reg_braz_12, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_12_pred <-  forecast_narfima_class(narfima_braz_12, PI = FALSE, h = n, xreg = test_reg_braz_12)
#set.seed(100)
...
set.seed(100)
narfima_braz_24 <-  auto_narfima(train_braz_24, arfima_er_braz_24, p = 2, q = 5, size = 1, skip = F, xreg = train_reg_braz_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_24_pred <-  forecast_narfima_class(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
set.seed(100)
...
set.seed(100)
narfima_braz_24 <-  auto_narfima(train_braz_24, arima_er_braz_24, p = 2, q = 5, size = 1, skip = F, xreg = train_reg_braz_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_24_pred <-  forecast_narfima_class(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
set.seed(100)
...
set.seed(100)
narfima_braz_24 <-  auto_narfima(train_braz_24, bsts_er_braz_24, p = 2, q = 5, size = 1, skip = F, xreg = train_reg_braz_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_24_pred <-  forecast_narfima_class(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
set.seed(100)
...
set.seed(100)
narfima_braz_24 <-  auto_narfima(train_braz_24, naive_er_braz_24, p = 2, q = 5, size = 1, skip = F, xreg = train_reg_braz_24, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_24_pred <-  forecast_narfima_class(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
set.seed(100)
...
#set.seed(100)
#narfima_braz_24 <-  auto_narfima(train_braz_24, tbats_er_braz_24, p = 2, q = 5, size = 1, skip = F, xreg = train_reg_braz_24, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_24_pred <-  forecast_narfima_class(narfima_braz_24, PI = FALSE, h = n, xreg = test_reg_braz_24)
#set.seed(100)
...
set.seed(100)
narfima_braz_48 <-  auto_narfima(train_braz_48, arfima_er_braz_48, p = 4, q = 2, size = 1  , skip = T, xreg = train_reg_braz_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_48_pred <-  forecast_narfima_class(narfima_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
set.seed(100)
...
set.seed(100)
narfima_braz_48 <-  auto_narfima(train_braz_48, arima_er_braz_48, p = 4, q = 2, size = 1  , skip = T, xreg = train_reg_braz_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_48_pred <-  forecast_narfima_class(narfima_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
set.seed(100)
...
set.seed(100)
narfima_braz_48 <-  auto_narfima(train_braz_48, bsts_er_braz_48, p = 4, q = 2, size = 1  , skip = T, xreg = train_reg_braz_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_braz_48_pred <-  forecast_narfima_class(narfima_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
set.seed(100)
...
set.seed(100)
narfima_braz_48 <-  auto_narfima(train_braz_48, naive_er_braz_48, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_braz_48, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_braz_48_pred <-  forecast_narfima_class(narfima_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
set.seed(100)
...
#set.seed(100)
#narfima_braz_48 <-  auto_narfima(train_braz_48, tbats_er_braz_48, p = 4, q = 2, size = 1  , skip = T, xreg = train_reg_braz_48, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_braz_48_pred <-  forecast_narfima_class(narfima_braz_48, PI = FALSE, h = n, xreg = test_reg_braz_48)
#set.seed(100)
...
set.seed(100)
narfima_rus_1 <-  auto_narfima(train_rus_1, arfima_er_rus_1, p = 1, q = 2, size = 2, skip = T, xreg = train_reg_rus_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_1_pred <-  forecast_narfima_class(narfima_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
set.seed(100)
narfima_rus_1 <-  auto_narfima(train_rus_1, arima_er_rus_1, p = 1, q = 2, size = 2, skip = T, xreg = train_reg_rus_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_1_pred <-  forecast_narfima_class(narfima_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
set.seed(100)
narfima_rus_1 <-  auto_narfima(train_rus_1, bsts_er_rus_1, p = 1, q = 2, size = 2, skip = T, xreg = train_reg_rus_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_1_pred <-  forecast_narfima_class(narfima_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
set.seed(100)
narfima_rus_1 <-  auto_narfima(train_rus_1, naive_er_rus_1, p = 1, q = 2, size = 2, skip = T, xreg = train_reg_rus_1, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_1_pred <-  forecast_narfima_class(narfima_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
#set.seed(100)
#narfima_rus_1 <-  auto_narfima(train_rus_1, tbats_er_rus_1, p = 1, q = 2, size = 2, skip = T, xreg = train_reg_rus_1, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_rus_1_pred <-  forecast_narfima_class(narfima_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
#set.seed(100)
...
set.seed(100)
narfima_rus_3 <-  auto_narfima(train_rus_3, arfima_er_rus_3, p = 1, q = 1, size = 1, skip = F, lambda = 0, lambdae = 0, repeats = 1000, xreg = train_reg_rus_3)
set.seed(100)
narfima_rus_3_pred <-  forecast_narfima_class(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
set.seed(100)
...
set.seed(100)
narfima_rus_3 <-  auto_narfima(train_rus_3, arima_er_rus_3, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_3_pred <-  forecast_narfima_class(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
set.seed(100)
...
set.seed(100)
narfima_rus_3 <-  auto_narfima(train_rus_3, bsts_er_rus_3, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_3_pred <-  forecast_narfima_class(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
set.seed(100)
...
set.seed(100)
narfima_rus_3 <-  auto_narfima(train_rus_3, naive_er_rus_3, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_3, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_3_pred <-  forecast_narfima_class(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
set.seed(100)
...
#set.seed(100)
#narfima_rus_3 <-  auto_narfima(train_rus_3, tbats_er_rus_3, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_3, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_rus_3_pred <-  forecast_narfima_class(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
#set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, arfima_er_rus_6, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima_class(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, arima_er_rus_6, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima_class(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, bsts_er_rus_6, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima_class(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, naive_er_rus_6, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_6, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima_class(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, tbats_er_rus_6, p = 1, q = 1, size = 1, skip = F, xreg = train_reg_rus_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima_class(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfima_rus_12 <-  auto_narfima(train_rus_12, arfima_er_rus_12, p = 5, q = 2, size = 5, skip = T, xreg = train_reg_rus_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_12_pred <-  forecast_narfima_class(narfima_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
set.seed(100)
narfima_rus_12 <-  auto_narfima(train_rus_12, arima_er_rus_12, p = 5, q = 2, size = 5, skip = T, xreg = train_reg_rus_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_12_pred <-  forecast_narfima_class(narfima_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
set.seed(100)
narfima_rus_12 <-  auto_narfima(train_rus_12, bsts_er_rus_12, p = 5, q = 2, size = 5, skip = T, xreg = train_reg_rus_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_12_pred <-  forecast_narfima_class(narfima_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
set.seed(100)
narfima_rus_12 <-  auto_narfima(train_rus_12, naive_er_rus_12, p = 5, q = 2, size = 5, skip = T, xreg = train_reg_rus_12, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_12_pred <-  forecast_narfima_class(narfima_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
#set.seed(100)
#narfima_rus_12 <-  auto_narfima(train_rus_12, tbats_er_rus_12, p = 5, q = 2, size = 5, skip = T, xreg = train_reg_rus_12, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_rus_12_pred <-  forecast_narfima_class(narfima_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
#set.seed(100)
...
set.seed(100)
narfima_rus_24 <-  auto_narfima(train_rus_24, arfima_er_rus_24, p = 1, q = 1, size = 5, skip = T, xreg = train_reg_rus_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_24_pred <-  forecast_narfima_class(narfima_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
...
set.seed(100)
narfima_rus_24 <-  auto_narfima(train_rus_24, arima_er_rus_24, p = 1, q = 1, size = 5, skip = T, xreg = train_reg_rus_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_24_pred <-  forecast_narfima_class(narfima_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
...
set.seed(100)
narfima_rus_24 <-  auto_narfima(train_rus_24, bsts_er_rus_24, p = 1, q = 1, size = 5, skip = T, xreg = train_reg_rus_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_24_pred <-  forecast_narfima_class(narfima_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
...
set.seed(100)
narfima_rus_24 <-  auto_narfima(train_rus_24, naive_er_rus_24, p = 1, q = 1, size = 5, skip = T, xreg = train_reg_rus_24, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_24_pred <-  forecast_narfima_class(narfima_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
...
#set.seed(100)
#narfima_rus_24 <-  auto_narfima(train_rus_24, tbats_er_rus_24, p = 1, q = 1, size = 5, skip = T, xreg = train_reg_rus_24, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_rus_24_pred <-  forecast_narfima_class(narfima_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
#set.seed(100)
...
set.seed(100)
narfima_rus_48 <-  auto_narfima(train_rus_48, arfima_er_rus_48, p = 3, q = 2, size = 1, skip = F, xreg = train_reg_rus_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
...
set.seed(100)
narfima_rus_48 <-  auto_narfima(train_rus_48, arima_er_rus_48, p = 3, q = 2, size = 1, skip = F, xreg = train_reg_rus_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_48_pred <-  forecast_narfima_class(narfima_rus_48, PI = FALSE, h = n, xreg = test_reg_rus_48)
set.seed(100)
...
set.seed(100)
narfima_rus_48 <-  auto_narfima(train_rus_48, bsts_er_rus_48, p = 3, q = 2, size = 1, skip = F, xreg = train_reg_rus_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_rus_48_pred <-  forecast_narfima_class(narfima_rus_48, PI = FALSE, h = n, xreg = test_reg_rus_48)
set.seed(100)
...
set.seed(100)
narfima_rus_48 <-  auto_narfima(train_rus_48, naive_er_rus_48, p = 3, q = 2, size = 1, skip = F, xreg = train_reg_rus_48, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_rus_48_pred <-  forecast_narfima_class(narfima_rus_48, PI = FALSE, h = n, xreg = test_reg_rus_48)
set.seed(100)
...
#set.seed(100)
#narfima_rus_48 <-  auto_narfima(train_rus_48, tbats_er_rus_48, p = 3, q = 2, size = 1, skip = F, xreg = train_reg_rus_48, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_rus_48_pred <-  forecast_narfima_class(narfima_rus_48, PI = FALSE, h = n, xreg = test_reg_rus_48)
#set.seed(100)
...
set.seed(100)
narfima_ind_1 <-  auto_narfima(train_ind_1, arfima_er_ind_1, p = 2, q = 1, size = 1, skip = T, xreg = train_reg_ind_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_1_pred <-  forecast_narfima_class(narfima_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
set.seed(100)
narfima_ind_1 <-  auto_narfima(train_ind_1, arima_er_ind_1, p = 2, q = 1, size = 1, skip = T, xreg = train_reg_ind_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_1_pred <-  forecast_narfima_class(narfima_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
set.seed(100)
narfima_ind_1 <-  auto_narfima(train_ind_1, bsts_er_ind_1, p = 2, q = 1, size = 1, skip = T, xreg = train_reg_ind_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_1_pred <-  forecast_narfima_class(narfima_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
set.seed(100)
narfima_ind_1 <-  auto_narfima(train_ind_1, naive_er_ind_1, p = 2, q = 1, size = 1, skip = T, xreg = train_reg_ind_1, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_1_pred <-  forecast_narfima_class(narfima_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
set.seed(100)
...
#set.seed(100)
#narfima_ind_1 <-  auto_narfima(train_ind_1, tbats_er_ind_1, p = 2, q = 1, size = 1, skip = T, xreg = train_reg_ind_1, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_1_pred <-  forecast_narfima_class(narfima_ind_1, PI = FALSE, h = n, xreg = test_reg_ind_1)
#set.seed(100)
...
set.seed(100)
narfima_ind_3 <-  auto_narfima(train_ind_3, arfima_er_ind_3, p = 4, q = 3, size = 4, skip = T, lambda = 0, lambdae = 0, repeats = 1000, xreg = train_reg_ind_3)
set.seed(100)
narfima_ind_3_pred <-  forecast_narfima_class(narfima_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
set.seed(100)
narfima_ind_3 <-  auto_narfima(train_ind_3, arima_er_ind_3, p = 4, q = 3, size = 4, skip = T, xreg = train_reg_ind_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_3_pred <-  forecast_narfima_class(narfima_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
set.seed(100)
narfima_ind_3 <-  auto_narfima(train_ind_3, bsts_er_ind_3, p = 4, q = 3, size = 4, skip = T, xreg = train_reg_ind_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_3_pred <-  forecast_narfima_class(narfima_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
set.seed(100)
narfima_ind_3 <-  auto_narfima(train_ind_3, naive_er_ind_3, p = 4, q = 3, size = 4, skip = T, xreg = train_reg_ind_3, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_3_pred <-  forecast_narfima_class(narfima_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
set.seed(100)
...
#set.seed(100)
#narfima_ind_3 <-  auto_narfima(train_ind_3, tbats_er_ind_3, p = 4, q = 3, size = 4, skip = T, xreg = train_reg_ind_3, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_3_pred <-  forecast_narfima_class(narfima_ind_3, PI = FALSE, h = n, xreg = test_reg_ind_3)
#set.seed(100)
...
set.seed(100)
narfima_ind_6 <-  auto_narfima(train_ind_6, arfima_er_ind_6, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_ind_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_6_pred <-  forecast_narfima_class(narfima_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
set.seed(100)
narfima_ind_6 <-  auto_narfima(train_ind_6, arima_er_ind_6, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_ind_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_6_pred <-  forecast_narfima_class(narfima_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
set.seed(100)
narfima_ind_6 <-  auto_narfima(train_ind_6, bsts_er_ind_6, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_ind_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_6_pred <-  forecast_narfima_class(narfima_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
set.seed(100)
narfima_ind_6 <-  auto_narfima(train_ind_6, naive_er_ind_6, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_ind_6, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_6_pred <-  forecast_narfima_class(narfima_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
set.seed(100)
...
#set.seed(100)
#narfima_ind_6 <-  auto_narfima(train_ind_6, tbats_er_ind_6, p = 4, q = 2, size = 1, skip = T, xreg = train_reg_ind_6, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_6_pred <-  forecast_narfima_class(narfima_ind_6, PI = FALSE, h = n, xreg = test_reg_ind_6)
#set.seed(100)
...
set.seed(100)
narfima_ind_12 <-  auto_narfima(train_ind_12, arfima_er_ind_12, p = 1, q = 3, size = 4, skip = T, xreg = train_reg_ind_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_12_pred <-  forecast_narfima_class(narfima_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
...
set.seed(100)
narfima_ind_12 <-  auto_narfima(train_ind_12, arima_er_ind_12, p = 1, q = 3, size = 4, skip = T, xreg = train_reg_ind_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_12_pred <-  forecast_narfima_class(narfima_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
...
set.seed(100)
narfima_ind_12 <-  auto_narfima(train_ind_12, bsts_er_ind_12, p = 1, q = 3, size = 4, skip = T, xreg = train_reg_ind_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_12_pred <-  forecast_narfima_class(narfima_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
...
set.seed(100)
narfima_ind_12 <-  auto_narfima(train_ind_12, naive_er_ind_12, p = 1, q = 3, size = 4, skip = T, xreg = train_reg_ind_12, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_12_pred <-  forecast_narfima_class(narfima_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
set.seed(100)
...
#set.seed(100)
#narfima_ind_12 <-  auto_narfima(train_ind_12, tbats_er_ind_12, p = 1, q = 3, size = 4, skip = T, xreg = train_reg_ind_12, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_12_pred <-  forecast_narfima_class(narfima_ind_12, PI = FALSE, h = n, xreg = test_reg_ind_12)
#set.seed(100)
...
set.seed(100)
narfima_ind_24 <-  auto_narfima(train_ind_24, arfima_er_ind_24, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_ind_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_24_pred <-  forecast_narfima_class(narfima_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
set.seed(100)
...
set.seed(100)
narfima_ind_24 <-  auto_narfima(train_ind_24, arima_er_ind_24, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_ind_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_24_pred <-  forecast_narfima_class(narfima_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
set.seed(100)
...
set.seed(100)
narfima_ind_24 <-  auto_narfima(train_ind_24, bsts_er_ind_24, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_ind_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_24_pred <-  forecast_narfima_class(narfima_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
set.seed(100)
...
set.seed(100)
narfima_ind_24 <-  auto_narfima(train_ind_24, naive_er_ind_24, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_ind_24, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_24_pred <-  forecast_narfima_class(narfima_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
set.seed(100)
...
#set.seed(100)
#narfima_ind_24 <-  auto_narfima(train_ind_24, tbats_er_ind_24, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_ind_24, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_24_pred <-  forecast_narfima_class(narfima_ind_24, PI = FALSE, h = n, xreg = test_reg_ind_24)
#set.seed(100)
...
set.seed(100)
narfima_ind_48 <-  auto_narfima(train_ind_48, arfima_er_ind_48, p = 2, q = 4, size = 4, skip = T, xreg = train_reg_ind_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_48_pred <-  forecast_narfima_class(narfima_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
set.seed(100)
...
set.seed(100)
narfima_ind_48 <-  auto_narfima(train_ind_48, arima_er_ind_48, p = 2, q = 4, size = 4, skip = T, xreg = train_reg_ind_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_48_pred <-  forecast_narfima_class(narfima_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
set.seed(100)
...
set.seed(100)
narfima_ind_48 <-  auto_narfima(train_ind_48, bsts_er_ind_48, p = 2, q = 4, size = 4, skip = T, xreg = train_reg_ind_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_ind_48_pred <-  forecast_narfima_class(narfima_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
set.seed(100)
...
set.seed(100)
narfima_ind_48 <-  auto_narfima(train_ind_48, naive_er_ind_48, p = 2, q = 4, size = 4, skip = T, xreg = train_reg_ind_48, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_ind_48_pred <-  forecast_narfima_class(narfima_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
set.seed(100)
...
#set.seed(100)
#narfima_ind_48 <-  auto_narfima(train_ind_48, tbats_er_ind_48, p = 2, q = 4, size = 4, skip = T, xreg = train_reg_ind_48, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_ind_48_pred <-  forecast_narfima_class(narfima_ind_48, PI = FALSE, h = n, xreg = test_reg_ind_48)
#set.seed(100)
...
set.seed(100)
narfima_chn_1 <-  auto_narfima(train_chn_1, arfima_er_chn_1, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_1_pred <-  forecast_narfima_class(narfima_chn_1, PI = FALSE, h = n, xreg = test_reg_chn_1)
set.seed(100)
...
set.seed(100)
narfima_chn_1 <-  auto_narfima(train_chn_1, arima_er_chn_1, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_1_pred <-  forecast_narfima_class(narfima_chn_1, PI = FALSE, h = n, xreg = test_reg_chn_1)
set.seed(100)
...
set.seed(100)
narfima_chn_1 <-  auto_narfima(train_chn_1, bsts_er_chn_1, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_1, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_1_pred <-  forecast_narfima_class(narfima_chn_1, PI = FALSE, h = n, xreg = test_reg_chn_1)
set.seed(100)
...
set.seed(100)
narfima_chn_1 <-  auto_narfima(train_chn_1, naive_er_chn_1, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_1, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_1_pred <-  forecast_narfima_class(narfima_chn_1, PI = FALSE, h = n, xreg = test_reg_chn_1)
set.seed(100)
...
#set.seed(100)
#narfima_chn_1 <-  auto_narfima(train_chn_1, tbats_er_chn_1, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_1, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_1_pred <-  forecast_narfima_class(narfima_chn_1, PI = FALSE, h = n, xreg = test_reg_chn_1)
#set.seed(100)
...
set.seed(100)
narfima_chn_3 <-  auto_narfima(train_chn_3, arfima_er_chn_3, p = 1, q = 2, size = 1, skip = T, lambda = 0, lambdae = 0, repeats = 1000, xreg = train_reg_chn_3)
set.seed(100)
narfima_chn_3_pred <-  forecast_narfima_class(narfima_chn_3, PI = FALSE, h = n, xreg = test_reg_chn_3)
set.seed(100)
...
set.seed(100)
narfima_chn_3 <-  auto_narfima(train_chn_3, arima_er_chn_3, p = 1, q = 2, size = 1, skip = T, xreg = train_reg_chn_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_3_pred <-  forecast_narfima_class(narfima_chn_3, PI = FALSE, h = n, xreg = test_reg_chn_3)
set.seed(100)
...
set.seed(100)
narfima_chn_3 <-  auto_narfima(train_chn_3, bsts_er_chn_3, p = 1, q = 2, size = 1, skip = T, xreg = train_reg_chn_3, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_3_pred <-  forecast_narfima_class(narfima_chn_3, PI = FALSE, h = n, xreg = test_reg_chn_3)
set.seed(100)
...
set.seed(100)
narfima_chn_3 <-  auto_narfima(train_chn_3, naive_er_chn_3, p = 1, q = 2, size = 1, skip = T, xreg = train_reg_chn_3, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_3_pred <-  forecast_narfima_class(narfima_chn_3, PI = FALSE, h = n, xreg = test_reg_chn_3)
set.seed(100)
...
#set.seed(100)
#narfima_chn_3 <-  auto_narfima(train_chn_3, tbats_er_chn_3, p = 1, q = 2, size = 1, skip = T, xreg = train_reg_chn_3, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_3_pred <-  forecast_narfima_class(narfima_chn_3, PI = FALSE, h = n, xreg = test_reg_chn_3)
#set.seed(100)
...
set.seed(100)
narfima_chn_6 <-  auto_narfima(train_chn_6, arfima_er_chn_6, p = 1, q = 1, size = 2, skip = F, xreg = train_reg_chn_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
...
set.seed(100)
narfima_chn_6 <-  auto_narfima(train_chn_6, arima_er_chn_6, p = 1, q = 1, size = 2, skip = F, xreg = train_reg_chn_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_6_pred <-  forecast_narfima_class(narfima_chn_6, PI = FALSE, h = n, xreg = test_reg_chn_6)
set.seed(100)
...
set.seed(100)
narfima_chn_6 <-  auto_narfima(train_chn_6, bsts_er_chn_6, p = 1, q = 1, size = 2, skip = F, xreg = train_reg_chn_6, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_6_pred <-  forecast_narfima_class(narfima_chn_6, PI = FALSE, h = n, xreg = test_reg_chn_6)
set.seed(100)
...
set.seed(100)
narfima_chn_6 <-  auto_narfima(train_chn_6, naive_er_chn_6, p = 1, q = 1, size = 2, skip = F, xreg = train_reg_chn_6, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_6_pred <-  forecast_narfima_class(narfima_chn_6, PI = FALSE, h = n, xreg = test_reg_chn_6)
set.seed(100)
...
#set.seed(100)
#narfima_chn_6 <-  auto_narfima(train_chn_6, tbats_er_chn_6, p = 1, q = 1, size = 2, skip = F, xreg = train_reg_chn_6, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_6_pred <-  forecast_narfima_class(narfima_chn_6, PI = FALSE, h = n, xreg = test_reg_chn_6)
#set.seed(100)
...
set.seed(100)
narfima_chn_12 <-  auto_narfima(train_chn_12, arfima_er_chn_12, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_12_pred <-  forecast_narfima_class(narfima_chn_12, PI = FALSE, h = n, xreg = test_reg_chn_12)
set.seed(100)
...
set.seed(100)
narfima_chn_12 <-  auto_narfima(train_chn_12, arima_er_chn_12, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_12, lambda = 0, lambdae = 0.5, repeats = 1000)
set.seed(100)
narfima_chn_12_pred <-  forecast_narfima_class(narfima_chn_12, PI = FALSE, h = n, xreg = test_reg_chn_12)
set.seed(100)
...
set.seed(100)
narfima_chn_12 <-  auto_narfima(train_chn_12, bsts_er_chn_12, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_12, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_12_pred <-  forecast_narfima_class(narfima_chn_12, PI = FALSE, h = n, xreg = test_reg_chn_12)
set.seed(100)
...
set.seed(100)
narfima_chn_12 <-  auto_narfima(train_chn_12, naive_er_chn_12, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_12, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_12_pred <-  forecast_narfima_class(narfima_chn_12, PI = FALSE, h = n, xreg = test_reg_chn_12)
set.seed(100)
...
#set.seed(100)
#narfima_chn_12 <-  auto_narfima(train_chn_12, tbats_er_chn_12, p = 5, q = 4, size = 1, skip = T, xreg = train_reg_chn_12, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_12_pred <-  forecast_narfima_class(narfima_chn_12, PI = FALSE, h = n, xreg = test_reg_chn_12)
#set.seed(100)
...
set.seed(100)
narfima_chn_24 <-  auto_narfima(train_chn_24, arfima_er_chn_24, p = 1, q = 2, size = 4, skip = T, xreg = train_reg_chn_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_24_pred <-  forecast_narfima_class(narfima_chn_24, PI = FALSE, h = n, xreg = test_reg_chn_24)
set.seed(100)
...
set.seed(100)
narfima_chn_24 <-  auto_narfima(train_chn_24, arima_er_chn_24, p = 1, q = 2, size = 4, skip = T, xreg = train_reg_chn_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_24_pred <-  forecast_narfima_class(narfima_chn_24, PI = FALSE, h = n, xreg = test_reg_chn_24)
set.seed(100)
...
set.seed(100)
narfima_chn_24 <-  auto_narfima(train_chn_24, bsts_er_chn_24, p = 1, q = 2, size = 4, skip = T, xreg = train_reg_chn_24, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_24_pred <-  forecast_narfima_class(narfima_chn_24, PI = FALSE, h = n, xreg = test_reg_chn_24)
set.seed(100)
...
set.seed(100)
narfima_chn_24 <-  auto_narfima(train_chn_24, naive_er_chn_24, p = 1, q = 2, size = 4, skip = T, xreg = train_reg_chn_24, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_24_pred <-  forecast_narfima_class(narfima_chn_24, PI = FALSE, h = n, xreg = test_reg_chn_24)
set.seed(100)
...
#set.seed(100)
#narfima_chn_24 <-  auto_narfima(train_chn_24, tbats_er_chn_24, p = 1, q = 2, size = 4, skip = T, xreg = train_reg_chn_24, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_24_pred <-  forecast_narfima_class(narfima_chn_24, PI = FALSE, h = n, xreg = test_reg_chn_24)
#set.seed(100)
...
set.seed(100)
narfima_chn_48 <-  auto_narfima(train_chn_48, arfima_er_chn_48, p = 4, q = 1, size = 2, skip = T, xreg = train_reg_chn_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_48_pred <-  forecast_narfima_class(narfima_chn_48, PI = FALSE, h = n, xreg = test_reg_chn_48)
set.seed(100)
...
set.seed(100)
narfima_chn_48 <-  auto_narfima(train_chn_48, arima_er_chn_48, p = 4, q = 1, size = 2, skip = T, xreg = train_reg_chn_48, lambda = 0, lambdae = 0.5, repeats = 1000)
set.seed(100)
narfima_chn_48_pred <-  forecast_narfima_class(narfima_chn_48, PI = FALSE, h = n, xreg = test_reg_chn_48)
set.seed(100)
...
set.seed(100)
narfima_chn_48 <-  auto_narfima(train_chn_48, bsts_er_chn_48, p = 4, q = 1, size = 2, skip = T, xreg = train_reg_chn_48, lambda = 0, lambdae = 0, repeats = 1000)
set.seed(100)
narfima_chn_48_pred <-  forecast_narfima_class(narfima_chn_48, PI = FALSE, h = n, xreg = test_reg_chn_48)
set.seed(100)
...
set.seed(100)
narfima_chn_48 <-  auto_narfima(train_chn_48, naive_er_chn_48, p = 4, q = 1, size = 2, skip = T, xreg = train_reg_chn_48, lambda = 0.00001, lambdae = 0.00001, repeats = 1000)
set.seed(100)
narfima_chn_48_pred <-  forecast_narfima_class(narfima_chn_48, PI = FALSE, h = n, xreg = test_reg_chn_48)
set.seed(100)
...
#set.seed(100)
#narfima_chn_48 <-  auto_narfima(train_chn_48, tbats_er_chn_48, p = 4, q = 1, size = 2, skip = T, xreg = train_reg_chn_48, lambda = 0, lambdae = 0, repeats = 1000)
#set.seed(100)
#narfima_chn_48_pred <-  forecast_narfima_class(narfima_chn_48, PI = FALSE, h = n, xreg = test_reg_chn_48)
#set.seed(100)
