...
set.seed(100)
narfimaT_rus_1 <-  auto_narfima(train_rus_1, arfima_er_rus_1, p = 1, q = 2, size = 2, lambda = 0, lambdae = 0, repeats = 1000, skip = T, xreg = train_reg_rus_1)
set.seed(100)
narfimaT_rus_1_pred <-  forecast_narfima(narfimaT_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
set.seed(100)
narfima_rus_3 <-  auto_narfima(train_rus_3, arfima_er_rus_3, p = 1, q = 1, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_rus_3)
set.seed(100)
narfima_rus_3_pred <-  forecast_narfima(narfima_rus_3, PI = FALSE, h = n, xreg = test_reg_rus_3)
set.seed(100)
...
set.seed(100)
narfima_rus_6 <-  auto_narfima(train_rus_6, arfima_er_rus_6, p = 1, q = 1, size = 1, lambda = 0, lambdae = 0, repeats = 1000, skip = F, xreg = train_reg_rus_6)
set.seed(100)
narfima_rus_6_pred <-  forecast_narfima(narfima_rus_6, PI = FALSE, h = n, xreg = test_reg_rus_6)
set.seed(100)
...
set.seed(100)
narfimaT_rus_12_pred <-  forecast_narfima(narfimaT_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
set.seed(100)
narfimaT_rus_24_pred <-  forecast_narfima(narfimaT_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
...
set.seed(100)
narfima_rus_48_pred <-  forecast_narfima(narfima_rus_48, PI = FALSE, h = n, xreg = test_reg_rus_48)
set.seed(100)
