...
set.seed(100)
narfimaT_rus_1_pred <-  forecast_narfima_class(narfimaT_rus_1, PI = FALSE, h = n, xreg = test_reg_rus_1)
set.seed(100)
...
set.seed(100)
narfimaT_rus_12_pred <-  forecast_narfima_class(narfimaT_rus_12, PI = FALSE, h = n, xreg = test_reg_rus_12)
set.seed(100)
...
set.seed(100)
narfimaT_rus_24_pred <-  forecast_narfima_class(narfimaT_rus_24, PI = FALSE, h = n, xreg = test_reg_rus_24)
set.seed(100)
